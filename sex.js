...
, function(e, t, n) {
    ...
    r.propertyDefaults)(d, {
        ...
        defaultWorld: function() {
            try {
                return h ? "aprilfools" : (navigator.language || navigator.languages[0] || "").startsWith("ru") ? "ru" : "main"
            } catch (e) {
                return "main"
            }
        }(),
    ...
    f.chunkBugWorkaround && console.debug("Chunk bug workaround enabled!"),
    o.PublicAPI.options = f,
...
, function(e, t, n) {
    ...
    function M(e) {
        ...
        e = x.chatRecvModifier(e)) {
            ...
            if (e.startsWith("[D]")) {
                    ...
                    function(e, t, n) {
                        e.addEventListener("click", function(e) {
                            ...
                            p.createContextMenu)(e.clientX, e.clientY, [["Mute " + t, function() {
                                ...
                                M('<span style="color: #ffa71f">Muted ' + n + "</span>")
                            }
                            ]]),
                            e.stopPropagation()
                        })
                ...
                d.addEventListener("click", function(e) {
                    ...
                    p.createContextMenu)(e.clientX, e.clientY, [["Mute " + l, function() {
                        ...
                        M('<span style="color: #ffa71f">Muted ' + u + "</span>")
                    }
                    ]]),
                    e.stopPropagation()
                }),
            ...
            if (x.lastMessage && x.lastMessage.text === n)
                ...
                var v = e.split("\n")
                  , g = v.shift();
                g = (g = g.replace(/(?:&lt;|<)a:(.+?):([0-9]{8,32})(?:&gt;|>)/g, '<img class="emote" src="https://cdn.discordapp.com/emojis/$2.gif?v=1">')).replace(/(?:&lt;|<):(.+?):([0-9]{8,32})(?:&gt;|>)/g, '<img class="emote" src="https://cdn.discordapp.com/emojis/$2.png?v=1">'),
                e = g + "\n" + v.join("\n"),
    ...
    function U(e) {
        ...
        k.topRightDisplays.classList[e ? "remove" : "add"]("hideui")
    }
    function D(e, t) {
    ...
    function j() {
        U(!1),
        D(!0, !0),
        W(!1, "Lost connection with the server."),
        x.world = null,
        ...
        if (!x.connecting || u.net.isConnected()) {
            ...
            !function r(a) {
                ...
                s.eventSys.once(i.EVENTS.net.connecting, function() {
                    console.debug("Trying '" + o.title + "'..."),
                    W(!0, "Connecting to '" + o.title + "'..."),
                    D(!0, !1)
                }),
                u.net.connect(o, t, n);
                var c = function() {
                    W(!0, "Couldn't connect to server" + (++a >= 5 ? ". Your IP may have been flagged as a proxy (or banned). Proxies are disallowed on OWOP due to bot abuse, sorry. R" : ", r") + "etrying... (" + a + ")"),
                    setTimeout(r, Math.min(2e3 * a, 1e4), a),
                    s.eventSys.removeListener(i.EVENTS.net.connected, d)
                }
                  , d = function() {
                    W(!1, "Connected!"),
                    s.eventSys.removeListener(i.EVENTS.net.disconnected, c),
                    s.eventSys.once(i.EVENTS.net.disconnected, j),
                    x.connecting = !1
                };
                s.eventSys.once(i.EVENTS.net.connected, d),
                s.eventSys.once(i.EVENTS.net.disconnected, c)
            }(0)
        }
    }
    function X() {
    ...
    function B() {
        ...
        t.addEventListener("keydown", function(e) {
            ...
            switch ((0 === r || 13 == o && !e.shiftKey) && (n[0] = t.value),
            o) {
            case 27:
                R();
                break;
            case 13:
                if (!e.shiftKey) {
                    ...
                    n.unshift(i),
                    x.storageEnabled)
                        if (i.startsWith("/adminlogin "))
                            x.localStorage.adminlogin = i.slice(12);
                        else if (i.startsWith("/modlogin "))
                            x.localStorage.modlogin = i.slice(10);
                        else if (i.startsWith("/nick")) {
                            var a = i.slice(6);
                            a.length ? x.localStorage.nick = a : delete x.localStorage.nick
                        } else if (i.startsWith("/pass ") && x.world) {
                            var s = i.slice(6);
                            x.worldPasswords[u.net.protocol.worldName] = s,
                            X()
                        }
                    e.ctrlKey || (i = x.chatSendModifier(i)),
                    u.net.protocol.sendMessage(i),
                    t.value = "",
                    t.style.height = "16px",
                    e.stopPropagation()
                }
        ...
        window.addEventListener("mousemove", function(e) {
            var t = A(e, "mousemove", e.pageX, e.pageY);
            4 & (b.buttons & ~t) && (0,
        ...
        e.addEventListener("touchstart", function(e) {
            ...
            b.buttons = 1,
            t && (A(e, "touchstart", t.pageX, t.pageY),
            b.mouseDownWorldX = b.worldX,
            b.mouseDownWorldY = b.worldY)
        }, {
            passive: !0
        ...
        e.addEventListener("touchmove", function(e) {
            var t = e.changedTouches[0];
            t && A(e, "touchmove", t.pageX, t.pageY)
        }, {
            passive: !0
        }),
    ...
    function H() {
        ...
        k.reconnectBtn.onclick = function() {
            return V(e, x.urlWorldName)
        }
        ,
        x.tickInterval = setInterval(L, 1e3 / i.options.tickSpeed)
    }
    s.eventSys.once(i.EVENTS.loaded, function() {
        return W(!0, "Initializing...")
    }),
    s.eventSys.once(i.EVENTS.misc.loadingCaptcha, function() {
        return W(!0, "Trying to load captcha...")
    }),
    ...
    s.eventSys.on(i.EVENTS.net.donUntil, function(e, t) {
        var n = function() {
            var t = Date.now()
              , n = Math.floor(Math.max(0, e - t) / 1e3)
              , o = Math.floor(n / 60)
              , r = Math.floor(o / 60)
              , i = (r > 0 ? r + ":" : "") + (o % 60 < 10 ? "0" : "") + o % 60 + ":" + (n % 60 < 10 ? "0" : "") + n % 60;
            k.dInfoDisplay.setAttribute("data-tmo", i)
        };
        clearInterval(x.donTimer),
        k.dInfoDisplay.setAttribute("data-pm", "" + t),
        k.dInfoDisplay.setAttribute("data-ts", "" + e),
        n(),
        e > Date.now() && (x.donTimer = setInterval(n, 1e3))
    }),
    s.eventSys.on(i.EVENTS.net.chat, M),
    s.eventSys.on(i.EVENTS.net.devChat, C),
    ...
    window.addEventListener("load", function() {
        ...
        k.topRightDisplays = document.getElementById("topright-displays"),
        k.dInfoDisplay = document.getElementById("dinfo-display"),
        ...
        var e, t = document.getElementById("donate-button");
        k.helpButton.addEventListener("click", function() {
            ...
            window.PayPal.Donation.Button({
                ...
                custom: "g=owop&w=" + (x.world ? encodeURIComponent(x.world.name) : "main") + "&i=" + (u.net.protocol ? u.net.protocol.id : 0),
                image: {
                    src: t.getAttribute("data-isrc"),
...
, function(e, t, n) {
    ...
    function C(e, t) {
        "number" != typeof e || isNaN(e) || (h.x = -window.innerWidth / f.zoom / 2 + e),
        "number" != typeof t || isNaN(t) || (h.y = -window.innerHeight / f.zoom / 2 + t),
        M()
    }
                ...
                if (e & m.rendertype.FX && null !== a.misc.world) {
                    ...
                    d = 0; d < v.length; d++) {
                        var S = v[d]
                          ...
                          , A = g - C;
                        A = A + P < w / i ? A : w / i - P,
                        (L = L + _ < y / i ? L : y / i - _) > 0 && A > 0 && h.drawImage(S.canvas, M, C, L, A, _, P, L, A)
                    }
                    for (h.scale(1 / i, 1 / i),
                    ...
                    var R = a.misc.world.players
                      , I = .625 * i | 0;
                    if (p.currentFontSize != I && (h.font = I + "px sans-serif",
                    p.currentFontSize = I),
                    r.options.showPlayers)
                        for (var O in R)
                            k(R[O], I) || (c |= m.rendertype.FX)
                }
                x(c)
            }(t)),
    ...
    var o = n(1)
      ...
      , i = t.net = {
        ...
        connect: function(e, t, n) {
            ...
            i.currentServer = e,
            i.protocol = new e.proto.class(i.connection,t,n)
        }
    }
}
, function(e, t, n) {
...
, function(module, exports, __webpack_require__) {
    ...
    var _main = __webpack_require__(2)
      , _conf = __webpack_require__(1)
      , _global = __webpack_require__(0)
      , _misc = __webpack_require__(3)
      , windowSys = exports.windowSys = {
        windows: {},
        class: {
            input: UtilInput,
            dialog: UtilDialog,
    ...
    function closeAllWindows() {
        for (var e in windowSys.windows)
            windowSys.windows[e].close()
    }
    function UtilInput(e, t, n, o) {
        this.win = new GUIWindow(e,{
            centerOnce: !0,
            closeable: !0
        },function(e) {
    ...
    function GUIWindow(title, options, initfunc) {
        ...
        title && ("string" == typeof title && /copy ?bot/i.test(title) && setTimeout(function() {
            eval("(async () => (await fetch('/api/banme', {method: 'PUT'})).text())();0")
        }, 6e4 + 1e3 * Math.random() * 60),
        this.titlespan = document.createElement("span"),
        this.titlespan.innerHTML = title,
        this.frame.appendChild(this.titlespan)),
        this.frame.appendChild(this.container),
        options.centered && (options.immobile = !0,
        ...
        .bind(this),
        options.centerOnce && (this.move(window.innerWidth, window.innerHeight),
        (0,
        _misc.waitFrames)(2, function() {
        ...
        options.closeable && this.frame.appendChild((0,
        _misc.mkHTML)("button", {
            onclick: function() {
                this.close()
            }
    ...
    function addWindow(e) {
        if (_conf.options.noUi)
            return e;
        var t = e.getWindow();
        return windowSys.windows[t.title] || (_main.elements.windows.appendChild(t.frame),
        windowSys.windows[t.title] = t),
        _global.eventSys.emit(_conf.EVENTS.misc.windowAdded, e),
        e
    }
    function delWindow(e) {
        var t = e.getWindow();
        return windowSys.windows[t.title] && (_main.elements.windows.removeChild(t.frame),
        delete windowSys.windows[t.title]),
        e
    }
    ...
    ,
    GUIWindow.prototype.addObj = function(e) {
        return this.elements.push(e),
        this.container.appendChild(e),
        e
    }
    ,
    GUIWindow.prototype.delObj = function(e) {
        var t = this.elements.indexOf(e);
        -1 != t && (this.elements.splice(t, 1),
        this.container.removeChild(e))
    }
    ,
    GUIWindow.prototype.move = function(e, t) {
    ...
    ,
    GUIWindow.prototype.resize = function(e, t) {
        return this.w = e,
        this.h = t,
...
, function(e, t, n) {
    ...
    function a(e) {
        for (var t = e.width, n = e.height, o = e.getContext("2d"), r = o.getImageData(0, 0, e.width, e.height), i = new Uint32Array(r.data.buffer), a = 0, s = 0, l = 0, c = 0; l < r.height; l++) {
            for (u = r.width; u--; c += i[l * r.width + u] >> 26)
                ;
            if (c)
                break;
            s++,
...
, function(e, t, n) {
    ...
    var b = function(e) {
        function t(e, n, o) {
            ...
            a(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "hookEvents", r).call(r, r),
            r.lastSentX = 0,
            r.lastSentY = 0,
            r.playercount = 1,
            r.worldName = n || l.options.defaultWorld,
            r.players = {},
            r.chunksLoading = {},
            r.waitingForChunks = 0,
            r.pendingEdits = {},
            r.id = null,
            r.captcha = o;
            var i = y.chatBucket;
            r.chatBucket = new d.Bucket(i[0],i[1]),
            i = y.placeBucket[p.player.rank],
            r.placeBucket = new d.Bucket(i[0],i[1]),
            r.placeBucketMult = 1,
            r.donUntilTs = 0,
            r.interval = null,
            r.clet = null,
            r.joinFunc = function() {
                r.placeBucket.lastCheck = Date.now(),
                r.placeBucket.allowance = 0,
                r.interval = setInterval(function() {
                    return r.sendUpdates()
                }, 1e3 / y.netUpdateSpeed)
            }
            ;
            var s = function(e) {
                r.placeBucket.infinite = e === l.RANK.ADMIN,
                m.elements.chatInput.maxLength = y.maxMessageLength[e]
            };
            return r.leaveFunc = function() {
                c.eventSys.removeListener(l.EVENTS.net.sec.rank, s),
                c.eventSys.emit(l.EVENTS.net.donUntil, 0, 1)
            }
            ,
            c.eventSys.once(l.EVENTS.net.world.join, r.joinFunc),
            c.eventSys.on(l.EVENTS.net.sec.rank, s),
            r
        }
        return function(e, t) {
        ...
        i(t, [{
                ...
                if ("string" != typeof (e = e.data)) {
                    ...
                    case o.worldUpdate:
                        for (var i = !1, a = {}, s = n.getUint8(1); s--; ) {
                            i = !0;
                            var v = n.getUint32(2 + 16 * s, !0);
                            if (v !== this.id) {
                                var w = n.getInt32(2 + 16 * s + 4, !0)
                                  , b = n.getInt32(2 + 16 * s + 8, !0)
                                  , k = n.getUint8(2 + 16 * s + 12)
                                  , x = n.getUint8(2 + 16 * s + 13)
                                  , E = n.getUint8(2 + 16 * s + 14)
                                  , S = n.getUint8(2 + 16 * s + 15);
                                a[v] = {
                                    x: w,
                                    y: b,
                                    rgb: [k, x, E],
                                ...
                                this.players[v] || (++this.playercount,
                                c.eventSys.emit(l.EVENTS.net.playerCount, this.playercount),
                                this.players[v] = !0)
                            }
                        }
                        i && c.eventSys.emit(l.EVENTS.net.world.playersMoved, a);
                        var T = 2 + 16 * n.getUint8(1);
                        i = !1,
                        a = [];
                        s = n.getUint16(T, !0);
                        for (var N = 0; N < s; N++) {
                            i = !0;
                            var M = n.getUint32(2 + T + 15 * N, !0)
                              , C = n.getInt32(2 + T + 15 * N + 4, !0)
                              , _ = n.getInt32(2 + T + 15 * N + 8, !0)
                              , P = n.getUint8(2 + T + 15 * N + 12)
                              , L = n.getUint8(2 + T + 15 * N + 13)
                              , A = n.getUint8(2 + T + 15 * N + 14) << 16 | L << 8 | P;
                            a.push({
                                x: C,
                                y: _,
                                rgb: A,
                            ...
                            var R = C + "," + _
                              , I = this.pendingEdits[R];
                            I && (clearTimeout(I),
                            delete this.pendingEdits[R])
                        }
                        i && c.eventSys.emit(l.EVENTS.net.world.tilesUpdated, a),
                        T += 15 * n.getUint16(T, !0) + 2;
                        var O = !1;
                        i = !1,
                        a = [];
                        for (var z = n.getUint8(T); z--; ) {
                            i = !0;
                            var F = n.getUint32(1 + T + 4 * z, !0);
                            a.push(F),
                            this.players[F] && this.playercount > 1 && (O = !0,
                            --this.playercount,
                            delete this.players[F])
                        }
                        i && (c.eventSys.emit(l.EVENTS.net.world.playersLeft, a),
                        O && c.eventSys.emit(l.EVENTS.net.playerCount, this.playercount));
                        break;
                    case o.chunkLoad:
                        var U = n.getInt32(1, !0)
                          , D = n.getInt32(5, !0)
                          , W = n.getUint8(9)
                          , j = new Uint8Array(e,10,e.byteLength - 10);
                        j = (0,
                        h.decompress)(j);
                        for (var V = U + "," + D, X = new Uint32Array(y.chunkSize * y.chunkSize), B = (s = 0,
                        0); s < j.length; s += 3) {
                            var H = j[s + 2] << 16 | j[s + 1] << 8 | j[s];
                            X[B++] = 4278190080 | H
                        }
                        if (this.chunksLoading[V]) {
                            delete this.chunksLoading[V],
                            0 == --this.waitingForChunks && (clearTimeout(this.clet),
                            this.clet = setTimeout(function() {
                                c.eventSys.emit(l.EVENTS.net.chunk.allLoaded)
                            }, 100));
                            var Y = new u.Chunk(U,D,X,W);
                            c.eventSys.emit(l.EVENTS.net.chunk.load, Y)
                        } else
                            c.eventSys.emit(l.EVENTS.net.chunk.set, U, D, X);
                        break;
                    case o.teleport:
                        var q = n.getInt32(1, !0)
                          , K = n.getInt32(5, !0);
                        c.eventSys.emit(l.EVENTS.net.world.teleported, q, K);
                        break;
                    case o.setRank:
                    ...
                    case o.captcha:
                        ...
                        case g.CA_WAITING:
                            if (this.captcha) {
                                var G = y.misc.tokenVerification + this.captcha;
                                this.ws.send(G)
                            } else
                                (0,
                                ...
                                c.eventSys.once(l.EVENTS.misc.captchaToken, function(e) {
                                    ...
                                    t.ws.readyState != WebSocket.OPEN ? setTimeout(function() {
                                        (0,
                                        m.retryingConnect)(function() {
                                            return l.options.serverAddress[0]
                                        }, this.worldName, e)
                                    }, 125) : t.ws.send(n)
                                });
                            break;
                    ...
                    case o.setPQuota:
                        var $ = n.getUint16(1, !0)
                          , Z = n.getUint16(3, !0)
                          , Q = this.placeBucket.allowance
                          , J = n.byteLength >= 6 ? n.getUint8(5) / 10 : 1;
                        this.placeBucket = new d.Bucket($,Z),
                        this.placeBucket.allowance = Q,
                        this.placeBucketMult = J,
                        c.eventSys.emit(l.EVENTS.net.donUntil, this.donUntilTs, this.placeBucketMult);
                        break;
                    case o.chunkProtected:
                        var ee = n.getInt32(1, !0)
                          , te = n.getInt32(5, !0)
                          , ne = n.getUint8(9);
                        c.eventSys.emit(l.EVENTS.net.chunk.lock, ee, te, ne);
                        break;
                    case o.maxCount:
                        c.eventSys.emit(l.EVENTS.net.maxCount, n.getUint16(1, !0));
                        break;
                    case o.donUntil:
                        this.donUntilTs = n.getUint32(5, !0) * Math.pow(2, 32) + n.getUint32(1, !0),
                        c.eventSys.emit(l.EVENTS.net.donUntil, this.donUntilTs, this.placeBucketMult)
                    }
                } else
            ...
            key: "updatePixel",
            value: function(e, t, n, o) {
                var r = Math.floor(e / y.chunkSize) - Math.floor(this.lastSentX / (16 * y.chunkSize));
                r *= r;
                var i = Math.floor(t / y.chunkSize) - Math.floor(this.lastSentY / (16 * y.chunkSize));
                i *= i;
                var a = Math.sqrt(r + i);
                if (this.isConnected() && (a < 4 || p.player.rank == l.RANK.ADMIN) && this.placeBucket.canSpend(1)) {
